...
@section('body')
    <main>
        ...
        <form action="">
         <table class=" text-center" style="margin: 0 auto" border-bottom="none">
             <tr>
                 <td>Name</td>
                 <td><input type="text" value="{{$about[0]->name}}" disabled></td>
                 <td>Number Phone</td>
                 <td><input type="text" value="{{$about[0]->numphone}}" disabled></td>
             </tr>
             <tr>
                 <td>Mail</td>
                 <td colspan="3"><input type="text" style="width: 100%" value="{{$about[0]->mail}}" disabled></td>
             </tr>
             <tr>
                 <td>Address</td>
                 <td colspan="3"><input type="text" style="width: 100%" value="{{$about[0]->diachi}}" disabled></td>
             </tr>
         </table>
        </form>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="team-member text-center">
                            ...
                            <figure>
                                <a href="#"><img src="storage/images/team-member2.jpg" alt="post" class="member-image"></a>
                            </figure>
                    ...
                    <div class="col-md-3 text-center">
                        ...
                        <div class="team-member text-center">
                            <figure>
                                <img src="storage/images/team-member5.jpg" alt="post" class="member-image">
                            </figure>
                            <div class="member-details text-center">
                    ...
                    <div class="col-md-3 text-center">
                        ...
                        <div class="team-member text-center">
                            <figure>
                                <img src="storage/images/team-member7.jpg" alt="post" class="member-image">
                            </figure>
                            <div class="member-details text-center">
                    ...
                    <div class="col-md-3 text-center">
                        ...
                        <div class="team-member text-center">
                            <figure>
                                <img src="storage/images/team-member3.jpg" alt="post" class="member-image">
                            </figure>
                            <div class="member-details text-center">
                                <h4>Mrs Lora Inn</h4>
        ...
        <section class="padding-large">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <img src="storage/images/post-img3.jpg" alt="book-authors" class="align-right">
                        <p>
